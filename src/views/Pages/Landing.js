...
<div className="wrapper">
        ...
        <div className="section " style={{padding: 0}}>
            <div className={" filter-gradient "+themeColors[day+2]+" section-gray"} data-color="orange">
     ...
     <div className="container" style={{marginTop:60}}>
            <div className="info">
                ...
                <p  style={{color: '#fff'}}>Loole.gg is a platform where you can challenge other gamers for real money on the line. Once you find a match you’ll play on your console (PS4/Xbox One), report results and we’ll deposit the money to the winner. There are other ways to win through multiplayer tourneys and monthly leader-board challenges.</p>
                <div className="row">
                {elements.map((value, index) => {
    return <div className="col-md-3" key={index}><img src={"https://www.gamingfrog.com/wp-content/uploads/2020/08/How-it-works-"+value+".jpg"} style={{maxWidth: '60%',margin:'10px auto',display:'block'}}/></div>
  })}
                </div>
                </div>
               </div>
