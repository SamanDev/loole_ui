...
class LandNavbar extends Component {
    ...
    render() {
        ...
        return (
            <Navbar
                className="position-absolute w-100 fixedtop"
                expand="lg"
                ...
                />
                    ...
                    {currentUser ? (
                      ...
                      />
                          ...
                          <Nav.Link to="/panel/dashboard" as={Link}>
                          <i className="nc-icon nc-grid-45"></i>
                  Dashboard
</Nav.Link>
                        </li>
                        <li  className={this.props.page =='login' ? "active" : ""}>
                          <Nav.Link onClick={e=>window.scrollTo({ behavior: 'smooth', top: myRef.current.offsetTop })} to="#about" as={Link}>
                          <i className="nc-icon nc-grid-45"></i>
                  About
</Nav.Link>
                        </li>
