      ...
      <>
        <Row>
          <Col md="6">
            ...
            >
              <Card className="stacked-form border-0">
                <Card.Header>
                  <Card.Title as="h4">Iran Shetab Deposit</Card.Title>
                </Card.Header>
                <Card.Body>
          ...
          <Col md="6">
            <Card className="stacked-form border-0">
              <Card.Header>
                <Card.Title as="h4">Select another method.</Card.Title>
              </Card.Header>
              <Card.Body>
